...
pub const terminal_search_set = terminal.search_set;
pub const terminal_search_clear = terminal.search_clear;
pub const terminal_search_select = terminal.search_select;
pub const terminal_search_select_index = terminal.search_select_index;
pub const terminal_search_status = terminal.search_status;
pub const terminal_search_selected = terminal.search_selected;
pub const terminal_search_viewport_matches_len = terminal.search_viewport_matches_len;
pub const terminal_search_viewport_matches = terminal.search_viewport_matches;
pub const terminal_search_matches = terminal.search_matches;
